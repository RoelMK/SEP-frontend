<template>
    <v-container>
        <h1 class="title">Enter Emotions</h1>
        <v-row align="center" justify="space-around" class="pdn">
            <b class="pdn">How happy are you?:</b>
            <v-icon
                class="pdn"
                x-large
        ...
        <v-row align="center" justify="space-around" class="pdn">
            <b class="pdn">How excited are you?:</b>
            <v-icon
                class="pdn"
                x-large
        ...
        <div class="pdn">
            <v-btn color="primary" elevation="2" rounded class="bttn">
                Enter Emotion
            </v-btn>
        </div>
    </v-container>
